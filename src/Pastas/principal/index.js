    ...
    return (
        <div>
            ...
            <div className="janela-modal" id="janela-modal">
                <div className="modal">
                    <a className='nv' href='Login'> <button className="but">Empresa</button></a>
                    <a className='nv' href='Login'> <button className="but">Profissional</button></a>
                </div>
            </div>

            <div className="janela-modal2" id="janela-modal2">
                <div className="modal2">
                    <a className='nv' href='FormPj'> <button className="but2">Empresa</button></a>
